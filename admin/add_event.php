<?php
	...
	if(!isset($_SESSION["hackathon_message"])){

		$_SESSION["hackathon_message"] = null;
						...
						<nav class="side-nav">
							...
							<ul class="unifyMenu" id="unifyMenu">
                                ...
                                <li>
									...
									<ul aria-expanded="false">
										<li>
											<a href="add_event.php">Create Events</a>
										</li>
										<li>
										...
										<div class="card-body">
											<div class="row gutters">
												<div class="col col-md-8">
													...
													<input type="text" class="form-control" required name="h_name" placeholder="Hackathon  Name">
												</div>
												<div class="col">
													<label for="exOne">Technology Tags</label>
													<input type="text" class="form-control" required name="h_tag" placeholder="Tags: Eg Java(Seperate tags with comma)">
												</div>
											...
											<div class="mt-2 row gutters">
												<div class="col">
													...
													<input type="date" class="form-control" required name="h_date_b" placeholder="Start Date">
												</div>
												<div class="col">
													<label for="exOne">Registration Time Line (End Date)</label>
													<input type="date" class="form-control" required name="h_date_e" placeholder="End Date">
												</div>
											...
											<div class="mt-2 row gutters">
												<div class="col">
														...
														<textarea class="form-control" id="textarea" name="h_description" rows="10"></textarea>
												</div>
											</div>
											<hr>
											<?php
